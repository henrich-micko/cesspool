...
urlpatterns = [
    ...
    path("<str:machine_code>/delete-record/", views.AdminMachineRecordAPIView.as_view(), name = "admin-machines-record"),
    path("<str:machine_code>/restore/", views.MachineAbortDeleteAPIView.as_view(), name = "admin-machines-record"),
    path("<str:machine_code>/delete-record/restore/", views.MachineAbortDeleteRecordsAPIView.as_view(), name = "admin-machines-record"),
]